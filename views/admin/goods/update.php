...
<div class="content">
    ...
    <div class="update">
        <form enctype="multipart/form-data" action="#" method="post">
            ...
            <label><p>Изображение тоара:</p>
                <a href="/<?= $imgAddress; ?>">
                    <img class="admin_good_picture" src="/<?= $imgThumbAddress; ?>" alt="<?= $name; ?>">
                </a>
            </label>
            ...
            <label><p>Описание товара:</p>
                <textarea name="description" cols="50"
                          rows="30"><?php if (isset($description)) print $description ?></textarea>
            </label>
            ...
            <label><p>Выберите изображение товара:</p>
                <input name="photo" type="file" value="Изображение товара">
